...
export const solutionsAccordion = [
  ...
  },
  {
    ...
    content: ' Obtendo fala e insights a nível global. Nossa solução tem suporte a 52 idiomas.',
  },
  {
    icon: Smiley,
    title: 'Análise de sentimento a partir do áudio',
    content: 'Encontre os momentos mais importantes em trechos de falas, diferencie falas positivas e negativas e tome decisões de negócios mais assertivas com uma compreensão mais profunda.',
  }
]